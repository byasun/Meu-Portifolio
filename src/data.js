...
export const projectsData = [
  { 
    ...
    image: 'https://via.placeholder.com/400x300/e74c3c/ffffff?text=ML+Model', 
    categories: ['ml'],
  ...
  { 
    ...
    image: 'https://via.placeholder.com/400x300/16a085/ffffff?text=Gestao+PDA',
    categories: ['backend'],
  ...
  { 
    id: 5,
    title: 'Novo PNCP',
    description: 'Implementação de sistema PNCP (Portal Nacional de Compras Públicas) com modernização de processos de licitação e compras. Backend escalável com arquitetura de microserviços e integração com APIs de governo.',
    image: 'https://via.placeholder.com/400x300/f39c12/ffffff?text=Sistema+PNCP',
    categories: ['backend'],
